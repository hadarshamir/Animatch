...
public class DebugActivity extends MainActivity
{
    ...
    private MediaPlayer         debugBgm, flip, shuffle;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        debugBgm     = MediaPlayer.create(DebugActivity.this, R.raw.settings_bgm);
        flip    = MediaPlayer.create(DebugActivity.this, R.raw.flip);
        shuffle = MediaPlayer.create(DebugActivity.this, R.raw.shuffle);
        debugBgm.setLooping(true);
        debugBgm.start();
    ...
    private void addColorIconsByNumberAndColor(int numOfColorIcons, boolean isRandom)
    {
        ...
        {
            colorIcon = new ImageButton(DebugActivity.this);
